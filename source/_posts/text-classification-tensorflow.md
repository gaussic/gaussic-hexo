---
title: CNN与RNN中文文本分类-基于TensorFlow实现
...
![data](text-classification-tensorflow/data.png)
...
![acc_loss](text-classification-tensorflow/cnn_architecture.png)
...
![acc_loss](text-classification-tensorflow/acc_loss.png)
...
![rnn_architecture](text-classification-tensorflow/rnn_architecture.png)
...
![acc_loss_rnn](text-classification-tensorflow/acc_loss_rnn.png)
